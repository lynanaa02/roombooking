    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card-modern">
                ...
                <form method="POST" action="{{ route('admin.ruangan.store') }}" enctype="multipart/form-data" id="createForm">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" name="kapasitas" class="form-control @error('kapasitas') is-invalid @enderror" value="{{ old('kapasitas') }}" required min="1">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="fasilitas" class="form-control @error('fasilitas') is-invalid @enderror" rows="3" placeholder="AC, Proyektor, Whiteboard, Sound System">{{ old('fasilitas') }}</textarea>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="upload-area">
                            ...
                            <label for="fotoRuangan" class="upload-label">
                                ...
                                <span>Klik untuk upload foto ruangan</span>
                                <small>JPG, PNG (Max 8MB)</small>
                            </label>
                        </div>
                        <small class="text-muted">Upload foto ruangan untuk tampilan yang lebih baik</small>
                    </div>
...
<script>
    ...
    document.getElementById('btnSimpanCreate')?.addEventListener('click', function(e) {
        ...
        showConfirmModal({
            ...
            message: 'Apakah Anda yakin ingin menyimpan data ruangan ini?',
            type: 'success',
    ...
    document.getElementById('btnBatalCreate')?.addEventListener('click', function(e) {
        ...
        showConfirmModal({
            ...
            onConfirm: function() {
                sessionStorage.setItem('flashMessage', 'Penambahan ruangan dibatalkan');
